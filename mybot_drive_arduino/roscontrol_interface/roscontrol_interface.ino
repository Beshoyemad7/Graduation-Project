...
#define ENCRA 19 // YELLOW
#define ENCRB 18 // GREEN
...
float count_per_rev_lm = 330.0;// <======== set this number according to your motor (count per rev) for left motor

float count_per_rev_rm = 330.0;// <======== set this number according to your motor (count per rev) for right motor
...
double RM_kp = 0.04, RM_ki = 1.3 , RM_kd = 0.00000;          // modify for optimal performance
